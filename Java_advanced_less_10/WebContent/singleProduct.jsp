...
<body>
	...
	<div class="container-fluid single-product">
		<div class="col">
			<div class="card">
				<div class="card-body">
					<h5 class="card-book">${book.name}</h5>
					<h5 class="card-author">${book.author}</h5>
					<h5 class="card-ganre">${book.ganre}</h5>
					<p class="card-cod">${book.cod}</p>
					<h6 class="card-price mb-2 text-muted">${book.price}</h6>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" product-id="${book.id}"
